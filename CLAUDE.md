...
## Current Version: v3.1 (2026-06-14)
...
**Key function:** `process_dat_file(file_obj, H0, Dia, sig_3, u, C, C1, C2, ...)`
...
4. Sidebar: H0, Dia, σ3, u, C/C1/C2, smoothing, temperature mode
5. Main area: How-to expander → file upload → LVDT selector → output settings → Process button → results
...
| u | 0.0 kPa | Pore pressure (0 = air-dried) |
